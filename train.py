...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
   # WEIGHTS_PATH_X = "./logs/https://github.com/bonlime/keras-deeplab-v3-plus/releases/download/1.1/deeplabv3_xception_tf_dim_ordering_tf_kernels.h5"
    weights_path = "logs/deeplabv3_xception_tf_dim_ordering_tf_kernels.h5"
    model.load_weights(weights_path,by_name=True,skip_mismatch=True)

    # 打开数据集的txt
    with open("./dataset2/train_data.txt","r") as f:
        lines = f.readlines()
